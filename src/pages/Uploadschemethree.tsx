...
/* ============================
   ...
   ============================ */
const FixedValueBox: React.FC<FixedValueBoxProps> = ({ label, value }) => {
  return (
    <div
      className="
...
{/* FIRST ROW — SPECIAL GRID */}
<div className="md:col-span-2">
  <div className="grid grid-cols-1 md:grid-cols-[475px_auto] gap-4">
    ...
    >
      ...
      <span className="text-[16px] text-[#101010] font-inter font-[500] truncate">
...
{/* REST OF FORM (UNTOUCHED) */}
<FixedValueBox label="Subject" value="Mathematics" />
...
<CustomSelect
  ...
  value={term}
  onChange={setTerm}
  options={["Second Term", "Third Term"]}
/>
...
export default UploadSchemethree;
